...
(cl:defmethod cl:initialize-instance :after ((m <Wheel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wheel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name model-msg:<Wheel> is deprecated: use model-msg:Wheel instead.")))

(cl:ensure-generic-function 'left_wheel-val :lambda-list '(m))
(cl:defmethod left_wheel-val ((m <Wheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader model-msg:left_wheel-val is deprecated.  Use model-msg:left_wheel instead.")
  (left_wheel m))

(cl:ensure-generic-function 'right_wheel-val :lambda-list '(m))
(cl:defmethod right_wheel-val ((m <Wheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader model-msg:right_wheel-val is deprecated.  Use model-msg:right_wheel instead.")
  (right_wheel m))

(cl:ensure-generic-function 'bottom_wheel-val :lambda-list '(m))
(cl:defmethod bottom_wheel-val ((m <Wheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader model-msg:bottom_wheel-val is deprecated.  Use model-msg:bottom_wheel instead.")
  (bottom_wheel m))
