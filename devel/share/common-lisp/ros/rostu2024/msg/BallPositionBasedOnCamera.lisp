...
(cl:defmethod cl:initialize-instance :after ((m <BallPositionBasedOnCamera>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallPositionBasedOnCamera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rostu2024-msg:<BallPositionBasedOnCamera> is deprecated: use rostu2024-msg:BallPositionBasedOnCamera instead.")))

(cl:ensure-generic-function 'distance-val :lambda-list '(m))
(cl:defmethod distance-val ((m <BallPositionBasedOnCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:distance-val is deprecated.  Use rostu2024-msg:distance instead.")
  (distance m))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <BallPositionBasedOnCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:angle-val is deprecated.  Use rostu2024-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'x_on_camera-val :lambda-list '(m))
(cl:defmethod x_on_camera-val ((m <BallPositionBasedOnCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:x_on_camera-val is deprecated.  Use rostu2024-msg:x_on_camera instead.")
  (x_on_camera m))

(cl:ensure-generic-function 'y_on_camera-val :lambda-list '(m))
(cl:defmethod y_on_camera-val ((m <BallPositionBasedOnCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:y_on_camera-val is deprecated.  Use rostu2024-msg:y_on_camera instead.")
  (y_on_camera m))

(cl:ensure-generic-function 'x_real-val :lambda-list '(m))
(cl:defmethod x_real-val ((m <BallPositionBasedOnCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:x_real-val is deprecated.  Use rostu2024-msg:x_real instead.")
  (x_real m))

(cl:ensure-generic-function 'y_real-val :lambda-list '(m))
(cl:defmethod y_real-val ((m <BallPositionBasedOnCamera>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:y_real-val is deprecated.  Use rostu2024-msg:y_real instead.")
  (y_real m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BallPositionBasedOnCamera>)))
  ...
  "rostu2024/BallPositionBasedOnCamera")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BallPositionBasedOnCamera)))
  "Returns string type for a message object of type 'BallPositionBasedOnCamera"
  "rostu2024/BallPositionBasedOnCamera")
