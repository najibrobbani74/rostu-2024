...
(cl:defmethod cl:initialize-instance :after ((m <DribbleModule>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DribbleModule)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rostu2024-msg:<DribbleModule> is deprecated: use rostu2024-msg:DribbleModule instead.")))

(cl:ensure-generic-function 'left_motor-val :lambda-list '(m))
(cl:defmethod left_motor-val ((m <DribbleModule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:left_motor-val is deprecated.  Use rostu2024-msg:left_motor instead.")
  (left_motor m))

(cl:ensure-generic-function 'right_motor-val :lambda-list '(m))
(cl:defmethod right_motor-val ((m <DribbleModule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:right_motor-val is deprecated.  Use rostu2024-msg:right_motor instead.")
  (right_motor m))
