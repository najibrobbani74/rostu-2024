...
(cl:defmethod cl:initialize-instance :after ((m <KickerModule>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KickerModule)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rostu2024-msg:<KickerModule> is deprecated: use rostu2024-msg:KickerModule instead.")))

(cl:ensure-generic-function 'trigger-val :lambda-list '(m))
(cl:defmethod trigger-val ((m <KickerModule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:trigger-val is deprecated.  Use rostu2024-msg:trigger instead.")
  (trigger m))

(cl:ensure-generic-function 'charger-val :lambda-list '(m))
(cl:defmethod charger-val ((m <KickerModule>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:charger-val is deprecated.  Use rostu2024-msg:charger instead.")
  (charger m))
