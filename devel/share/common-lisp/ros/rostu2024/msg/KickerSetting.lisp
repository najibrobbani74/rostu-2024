...
(cl:defmethod cl:initialize-instance :after ((m <KickerSetting>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KickerSetting)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rostu2024-msg:<KickerSetting> is deprecated: use rostu2024-msg:KickerSetting instead.")))

(cl:ensure-generic-function 'charge_time-val :lambda-list '(m))
(cl:defmethod charge_time-val ((m <KickerSetting>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:charge_time-val is deprecated.  Use rostu2024-msg:charge_time instead.")
  (charge_time m))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <KickerSetting>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu2024-msg:action-val is deprecated.  Use rostu2024-msg:action instead.")
  (action m))
