...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rostu2024-msg:<RobotStatus> is deprecated: use rostu2024-msg:RobotStatus instead.")))
