...
(cl:defmethod cl:initialize-instance :after ((m <NavigationSetting>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigationSetting)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rostu_interfaces-msg:<NavigationSetting> is deprecated: use rostu_interfaces-msg:NavigationSetting instead.")))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <NavigationSetting>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu_interfaces-msg:speed-val is deprecated.  Use rostu_interfaces-msg:speed instead.")
  (speed m))

(cl:ensure-generic-function 'direction-val :lambda-list '(m))
(cl:defmethod direction-val ((m <NavigationSetting>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu_interfaces-msg:direction-val is deprecated.  Use rostu_interfaces-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'rotation-val :lambda-list '(m))
(cl:defmethod rotation-val ((m <NavigationSetting>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu_interfaces-msg:rotation-val is deprecated.  Use rostu_interfaces-msg:rotation instead.")
  (rotation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<NavigationSetting>)))
  ...
  "rostu_interfaces/NavigationSetting")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'NavigationSetting)))
  "Returns string type for a message object of type 'NavigationSetting"
  "rostu_interfaces/NavigationSetting")
