...
(cl:defmethod cl:initialize-instance :after ((m <Wheel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Wheel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rostu_interfaces-msg:<Wheel> is deprecated: use rostu_interfaces-msg:Wheel instead.")))

(cl:ensure-generic-function 'left_wheel-val :lambda-list '(m))
(cl:defmethod left_wheel-val ((m <Wheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu_interfaces-msg:left_wheel-val is deprecated.  Use rostu_interfaces-msg:left_wheel instead.")
  (left_wheel m))

(cl:ensure-generic-function 'right_wheel-val :lambda-list '(m))
(cl:defmethod right_wheel-val ((m <Wheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu_interfaces-msg:right_wheel-val is deprecated.  Use rostu_interfaces-msg:right_wheel instead.")
  (right_wheel m))

(cl:ensure-generic-function 'bottom_wheel-val :lambda-list '(m))
(cl:defmethod bottom_wheel-val ((m <Wheel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rostu_interfaces-msg:bottom_wheel-val is deprecated.  Use rostu_interfaces-msg:bottom_wheel instead.")
  (bottom_wheel m))
