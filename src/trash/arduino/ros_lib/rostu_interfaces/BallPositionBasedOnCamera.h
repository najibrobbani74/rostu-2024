#ifndef _ROS_rostu_interfaces_BallPositionBasedOnCamera_h
#define _ROS_rostu_interfaces_BallPositionBasedOnCamera_h
...
namespace rostu_interfaces
{
  ...
  class BallPositionBasedOnCamera : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rostu_interfaces/BallPositionBasedOnCamera"; };
