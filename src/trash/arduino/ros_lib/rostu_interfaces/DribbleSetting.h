#ifndef _ROS_rostu_interfaces_DribbleSetting_h
#define _ROS_rostu_interfaces_DribbleSetting_h
...
namespace rostu_interfaces
{
  ...
  class DribbleSetting : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rostu_interfaces/DribbleSetting"; };
