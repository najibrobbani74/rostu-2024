#ifndef _ROS_rostu_interfaces_KickerModule_h
#define _ROS_rostu_interfaces_KickerModule_h
...
namespace rostu_interfaces
{
  ...
  class KickerModule : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rostu_interfaces/KickerModule"; };
