#ifndef _ROS_rostu_interfaces_KickerSetting_h
#define _ROS_rostu_interfaces_KickerSetting_h
...
namespace rostu_interfaces
{
  ...
  class KickerSetting : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rostu_interfaces/KickerSetting"; };
