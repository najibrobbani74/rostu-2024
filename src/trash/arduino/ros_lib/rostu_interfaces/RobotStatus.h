#ifndef _ROS_rostu_interfaces_RobotStatus_h
#define _ROS_rostu_interfaces_RobotStatus_h
...
namespace rostu_interfaces
{
  ...
  class RobotStatus : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "rostu_interfaces/RobotStatus"; };
